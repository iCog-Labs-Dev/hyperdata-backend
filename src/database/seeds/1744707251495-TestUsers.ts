...
export default class TestUsers1744707251495 implements Seeder {
  ...
  public async run(
    ...
    const getRoleId = (name: string) =>
      roles.find((r: any) => r.name === name)?.id;

    const users = [
      {
        email: 'super@gmail.com',
        first_name: 'SuperAdmin 0',
        role: 'SuperAdmin',
      },
      {
        email: 'super1@gmail.com',
        first_name: 'SuperAdmin 1',
        role: 'SuperAdmin',
      },
      {
        email: 'faci@gmail.com',
        first_name: 'Facilitator 0',
        role: 'Facilitator',
      },
      ...
      },
      {
        ...
        first_name: 'ProjectManager 0',
        role: 'ProjectManager',
      },
      {
        email: 'proj1@gmail.com',
        first_name: 'ProjectManager 1',
        role: 'ProjectManager',
      },
      {
        email: 'faci1@gmail.com',
        first_name: 'Facilitator 1',
        role: 'Facilitator',
      },
    ];
